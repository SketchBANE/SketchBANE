...
if __name__ == '__main__':
    ...
    print(
        f'【T={T},K={K}】acc：{average_accuracy * 100:.4f}--var_accuracy：{variance_accuracy * 10000:.4f}--micro-f1: {average_micro_f1 * 100:.4f}--var_micro：{variance_micro_f1 * 10000:.4f}--macro-f1: {average_macro_f1 * 100:.4f}--var_macro：{variance_macro_f1 * 10000:.4f}')

    log_path = '../results/' + dataset + '/multi-label_ExpandedIP.log'
