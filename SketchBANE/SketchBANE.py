...
if __name__ == '__main__':
    ...
    adjacency_path = 'datas/' + dataset + '/network.npz'
    attribute_path = 'datas/' + dataset + '/attrs.npz'
    attribute_matrix = load_npz(attribute_path)
    adjacency_matrix = load_npz(adjacency_path)

    print(f'G:{adjacency_matrix.shape}---A:{attribute_matrix.shape}---G:{type(adjacency_matrix)}---A:{type(attribute_matrix)}')
